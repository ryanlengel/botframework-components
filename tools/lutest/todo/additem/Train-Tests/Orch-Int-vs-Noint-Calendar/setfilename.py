...
#%%
for i in range(0,5):
    orch_result = ".\\todo\\additem\\Train-Tests\\Orch-Int-vs-Noint-Calendar\\report" + str(i) + "\\orchestrator_testing_set_scores.txt"
    orch_noint_result = ".\\todo\\additem\\Train-Tests\\Orch-Int-vs-Noint-Calendar\\report-noint" + str(i) + "\\orchestrator_testing_set_scores.txt"
